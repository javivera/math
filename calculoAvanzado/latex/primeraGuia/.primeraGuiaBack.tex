...
$3 \Ra 1)$ Suponemos que $A$ es finito , sea $x \in A$ por hipótesis existe $f: A \ra A \setminus \{x\}$ Biyectiva. Pero entonces $\# A = \# A \setminus \{x\}$ lo que es absurdo
\end{ej}
\noindent
\begin{ej} Ej 12) Sea $A$ un conjunto numerable y $B$ un conjunto. Supongamos que existe un $f:A \ra B$ sobreyectiva. Entonces $B$ es a lo sumo numerable
\begin{proof}
